#undef ARCANENOMADS_API
#undef ARCANENOMADS_VTABLE
...
#define UE_PROJECT_NAME ArcaneNomads
...
#define ARCANENOMADS_VTABLE DLLEXPORT_VTABLE
#define ARCANENOMADS_API DLLEXPORT
