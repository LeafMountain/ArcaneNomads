...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AArcaneNomadsCharacter_Statics::NewProp_BaseLookUpRate = { "BaseLookUpRate", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AArcaneNomadsCharacter, BaseLookUpRate), METADATA_PARAMS(Z_Construct_UClass_AArcaneNomadsCharacter_Statics::NewProp_BaseLookUpRate_MetaData, ARRAY_COUNT(Z_Construct_UClass_AArcaneNomadsCharacter_Statics::NewProp_BaseLookUpRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AArcaneNomadsCharacter_Statics::NewProp_CameraBoom = { "CameraBoom", nullptr, (EPropertyFlags)0x00400000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AArcaneNomadsCharacter, CameraBoom), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AArcaneNomadsCharacter_Statics::NewProp_CameraBoom_MetaData, ARRAY_COUNT(Z_Construct_UClass_AArcaneNomadsCharacter_Statics::NewProp_CameraBoom_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AArcaneNomadsCharacter_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AArcaneNomadsCharacter_Statics::PropPointers),
		0,
		0x008000A0u,
		METADATA_PARAMS(Z_Construct_UClass_AArcaneNomadsCharacter_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AArcaneNomadsCharacter_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AArcaneNomadsCharacter, 3103587090);
