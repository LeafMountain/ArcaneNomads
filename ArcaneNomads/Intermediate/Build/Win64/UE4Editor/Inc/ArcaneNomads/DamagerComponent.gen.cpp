...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDamagerComponent_Damage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDamagerComponent, nullptr, "Damage", nullptr, nullptr, sizeof(DamagerComponent_eventDamage_Parms), Z_Construct_UFunction_UDamagerComponent_Damage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDamagerComponent_Damage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDamagerComponent_Damage_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDamagerComponent_Damage_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDamagerComponent_SetOwner_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDamagerComponent, nullptr, "SetOwner", nullptr, nullptr, sizeof(DamagerComponent_eventSetOwner_Parms), Z_Construct_UFunction_UDamagerComponent_SetOwner_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDamagerComponent_SetOwner_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDamagerComponent_SetOwner_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDamagerComponent_SetOwner_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDamagerComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDamagerComponent_Damage, "Damage" }, // 2341394114
		{ &Z_Construct_UFunction_UDamagerComponent_SetOwner, "SetOwner" }, // 426196026
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDamagerComponent_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UClass_UDamagerComponent_Statics::PropPointers),
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UDamagerComponent_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDamagerComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UDamagerComponent, 2644551090);
